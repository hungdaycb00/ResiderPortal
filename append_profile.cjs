...
const profileStr = `
                                {mainTab === 'profile' && !selectedUser && (
                                    <div className="space-y-4 pt-2">
                                        ...
                                        {/* User ID + Copy */}
                                        <div className="bg-gray-50 rounded-2xl p-3 flex items-center justify-between gap-2 mb-4">
                                        ...
                                        {activeTab === 'info' ? (
                                            <>
                                                ...
                                                {games && games.length > 0 && (
                                                    <div className="mt-2">
                                                        <h4 className="text-[13px] font-bold text-gray-900 mb-3">🎮 Games You Created</h4>
                                            ...
                                            <div className="pb-8">
                                                <div className="mb-6">
                                                    {!isCreatingPost ? (
                                                        ...
                                                        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                                            ...
                                                            />
                                                            <p className="text-[10px] text-right text-gray-400 mb-2">{postTitle.length}/50</p>
                                                            <div className="flex gap-2">
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full text-gray-400 hover:text-gray-600 text-xs font-medium py-1 transition-colors mt-2"
                                                            >
                                                                Cancel
                                                            </button>
                                                            {isSavingPost && <p className="text-[10px] text-blue-500 text-center animate-pulse mt-1">Posting...</p>}
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                {userPosts.length > 0 ? (
                                                    ...
                                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                                        ...
                                                        <p className="text-gray-300 text-[11px] mt-1">Create your first post above!</p>
                                                    </div>
                                                )}
                                            </div>
                                        )}
...
code = code.replace(
    /(\{\/\* Blocked Users \*\/\}\s*\{socialSection === 'blocked' && \(\s*<div className="py-10 text-center bg-gray-50 rounded-\[32px\]">\s*<div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-sm">\s*<AlertTriangle className="w-6 h-6 text-gray-200" \/>\s*<\/div>\s*<p className="text-gray-400 text-xs font-medium">No blocked users<\/p>\s*<\/div>\s*\)\}\s*<\/div>\s*\)\})/g,
    `$1\n${profileStr}`
);

fs.writeFileSync(file, code);
console.log('Appended profile to main document.');
