...
const MapControls: React.FC<MapControlsProps> = ({
    ...
    isWidgetExpanded, setIsWidgetExpanded, isSheetExpanded, mainTab
}) => {
    ...
    return (
        <>
            ...
            <div className={`absolute right-2 md:right-8 z-[360] flex flex-col gap-2 md:gap-3 pointer-events-auto transition-all duration-500 
                ${isLooterGameMode 
                    ? (isSheetExpanded ? 'bottom-[62%]' : 'bottom-[42%]') 
                    : 'bottom-[75px] md:bottom-12'
                }
                ${isSheetExpanded && ['discover', 'friends', 'profile', 'notifications', 'creator'].includes(mainTab || '') 
