...
const billboardTransform = (_: unknown, generated: string) =>
    `${generated} rotateZ(var(--alin-map-billboard-yaw-deg)) rotateX(var(--alin-map-billboard-stand-deg)) scale(var(--alin-map-node-counter-scale)) scale(var(--alin-map-featured-scale, 1))`;
