...
const billboardTransform = (_: unknown, generated: string) => `${generated} translateZ(52px) rotateX(var(--alin-map-billboard-tilt-deg)) scale(var(--alin-map-node-counter-scale))`;
