...
import { Search, MapPin, Navigation, MessageCircle, User, UserPlus, Compass } from 'lucide-react';
...
const NavigationBar: React.FC<NavigationBarProps> = ({ mainTab, selectedUser, isDesktop, handleTabClick }) => {
    return (
        <>
