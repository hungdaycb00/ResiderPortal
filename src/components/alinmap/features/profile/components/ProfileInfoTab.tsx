        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 mb-6">
                <button
                    ...
                    className={`min-w-0 flex items-center justify-center gap-1.5 py-2.5 px-1.5 rounded-2xl border transition-all whitespace-nowrap ${activeList === 'friends' ? 'bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-200' : 'bg-white border-gray-100 text-gray-700 hover:bg-gray-50'}`}
                >
                ...
                <button
                    ...
                    className={`min-w-0 flex items-center justify-center gap-1.5 py-2.5 px-1.5 rounded-2xl border transition-all whitespace-nowrap ${activeList === 'invites' ? 'bg-amber-500 border-amber-500 text-white shadow-lg shadow-amber-200' : 'bg-white border-gray-100 text-gray-700 hover:bg-gray-50'}`}
                >
                ...
                <button
                    ...
                    className={`min-w-0 flex items-center justify-center gap-1.5 py-2.5 px-1.5 rounded-2xl border transition-all whitespace-nowrap ${activeList === 'blocked' ? 'bg-red-600 border-red-600 text-white shadow-lg shadow-red-200' : 'bg-white border-gray-100 text-gray-700 hover:bg-gray-50'}`}
                >
